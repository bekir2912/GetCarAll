...
$all_cats = Category::find()->where(['parent_id' => null, 'status' => 1])->orderBy('`order`')->all();
...
?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#ru" aria-controls="ru" role="tab"  data-toggle="tab"><?=Yii::t('frontend', 'ru')?></a></li>
    ...
    <div class="separator"></div>
    <div class="form-group">
        <a href="<?= Url::to(['product/index', 'sort' => '-id', 'ProductSearch[shop_id]' => $model->shop_id]) ?>" class="btn btn-secondary btn-cancel">Назад</a>
        ...
        <?php if(!$model->isNewRecord) { ?>
            <?php if($model->status == -1) { ?>
                <div class="div-inline">
                    <form action="<?=Url::to(['product/block'])?>" method="post">
