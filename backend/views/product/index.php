...
$brands = Product::find()->select('brand_id')->where(['shop_id' => Yii::$app->session->get('shop_id')])->orderBy('brand_id')->groupBy('brand_id')->all();
...
<div class="product-index">
    <?php if(!empty(Yii::$app->request->queryParams['ProductSearch']['shop_id'])) { ?>
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-tabs" >
                <li role="presentation"><a href="<?=Url::to(['shop/update', 'id' => Yii::$app->session->get('shop_id')])?>">Компания</a></li>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function($data) {
                        $link = '';
                        return $data->translate->name.$link;
                    },
                ],
                'articul',
                [
