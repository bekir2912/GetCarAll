...
<div class="row">
    <div class="col-sm-12">
        <div class="row">
            <div class="col-sm-4">
                <a href="<?=Url::to(['moderating/index', 'sort' => '-id'])?>">
            ...
            <div class="col-sm-4">
                <a href="<?=Url::to(['moderating/index', 'sort' => '-id'])?>">
                    <div class="badge-block text-center text-muted" style="background: <?=$products_color?>;">
                        ...
                        <p>Объявлений сегодня</p>
                    </div>
                </a>
            </div>
            <div class="col-sm-4">
                <a href="<?=Url::to(['moderating/index', 'ProductSearch[status]' => 1, 'sort' => '-id'])?>">
                    <div class="badge-block text-center text-muted" style="background: <?=$products_color?>;">
                        <?=FA::i('check')->size('3x')?>
                        <span>
            ...
            <div class="col-sm-4">
                <a href="<?=Url::to(['user/index', 'sort' => '-id'])?>">
                    <div class="badge-block text-center text-muted" style="background: <?=$users_color?>;">
                        ...
                        <p>Поль-лей сегодня</p>
                    </div>
                </a>
            </div>
            <div class="col-sm-4">
                <a href="<?=Url::to(['user/index', 'UserSearch[status]' => 10, 'sort' => '-id'])?>">
                    <div class="badge-block text-center text-muted" style="background: <?=$users_color?>;">
                        <?=FA::i('check')->size('3x')?>
                        <span>
                            <?=($users_active)? $users_active: 0?>
                        </span>
                        <p>Активных поль-лей</p>
                    </div>
                </a>
            </div>
        </div>
            ...
            <div class="col-sm-4">
                <a href="<?=Url::to(['shop/index',  'sort' => '-id'])?>">
                    <div class="badge-block text-center text-muted" style="background: <?=$shops_color?>;">
                        ...
                        <p>Компаний сегодня</p>
                    </div>
                </a>
            </div>
            <div class="col-sm-4">
                <a href="<?=Url::to(['shop/index', 'ShopSearch[status]' => 1, 'sort' => '-id'])?>">
                    <div class="badge-block text-center text-muted" style="background: <?=$shops_color?>;">
                        <?=FA::i('check')->size('3x')?>
                        <span>
                ...
                <div class="site-index">
                    <div class="page-header">
                        ...
                        <small class="pull-right">
                            <a href="<?=Url::to(['shop/index', 'sort' => '-id'])?>">Все компании</a>
                        </small>
                    </div>
                    <p></p>
                    <?php if(!empty($shops)) { ?>
                            ...
                            <table class="table table-stripped table-hover">
                                ...
                                <?php foreach ($shops as $shop) { ?>
                                    <tr>
                                        ...
                                        <td><?=($shop->top == 1)? 'Да': 'Нет';?></td>
                                        <td><?=($shop->on_main == 1)? 'Да': 'Нет';?></td>
                                        <td><?=$shop->service.'%'?></td>
                                        <td><?=date('d.m.Y', $shop->created_at)?></td>

                                        <td>
                                            <?php $ahopstatusFormat = [
                                                '0' => '<span class="text-info">'.FA::i('clock-o').' На модерации'.'</span>',
                                        ...
                                        <td><a href="<?=Url::to(['shop/update', 'id' => $shop->id])?>"><?=FA::i('sign-in-alt')->addCssClass('text-secondary')?></a></td>
                            ...
                            <table class="table table-stripped table-hover">
                                ...
                                <?php foreach ($last_products as $top_prod) { ?>
                                    <tr>
                                        ...
                                        <td><a href="<?=Url::to(['product/update', 'id' => $top_prod->id, 'category' => $top_prod->category_id, 'brand' => $top_prod->brand_id, 'lineup' => $top_prod->lineup_id])?>"><?=FA::i('sign-in-alt')->addCssClass('text-secondary')?></a></td>
                                    </tr>
                                <?php } ?>
                            </table>
                        </div>
                            ...
                            <table class="table table-stripped table-hover">
                                ...
                                <?php foreach ($last_reviews as $review) { ?>
                                    <tr>
                                        ...
                                        <td><a href="<?=Url::to(['review/update', 'id' => $review->id])?>"><?=FA::i('sign-in-alt')->addCssClass('text-secondary')?></a></td>
                                    </tr>
                                <?php } ?>
                            </table>
                        </div>
