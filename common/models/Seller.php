...
class Seller extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['ucard', 'balance'], 'integer'],
            [['password'], 'string', 'min' => 6, 'max' => 16, 'on' => 'admin'],
            [['name'], 'required', 'on' => 'create'],
            [['name', 'phone'], 'string', 'on' => 'create'],
            [['password'], 'string', 'min' => 6, 'max' => 16, 'on' => 'create'],
            [['password'], 'required', 'on' => 'create'],
            ['status', 'default', 'value' => self::STATUS_ACTIVE],
            ['status', 'in', 'range' => [self::STATUS_ACTIVE, self::STATUS_DELETED]],
            ['username', 'unique', 'targetClass' => '\common\models\Seller', 'message' => 'Этот E-mail уже занят.', 'on' => 'admin'],
        ];
    }
...
//    }
    ...
    {
        return $this->hasMany(Shop::className(), ['seller_id' => 'id']);
    }
    /**
     * @inheritdoc
     */
