...
//            ['logo', 'image', 'extensions' => 'jpg, jpeg, png', 'maxSize' => 1024 * 1024 * 2],
    ...
    {
        return $this->hasMany(Booking::className(), ['shop_id' => 'id']);
    }
    /**
     * @return \yii\db\ActiveQuery
     */
    ...
    public function getBokingPickup()
    {
        return $this->hasMany(Booking::className(), ['pickup_shop_id' => 'id']);
    }

    public function getBokingReturn()
    {
        return $this->hasMany(Booking::className(), ['return_shop_id' => 'id']);
    }
