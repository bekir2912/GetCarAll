...
FileInputThemeAsset::register($this);
...
<div class="product-form">
                ...
                <div class="col-lg-12">
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4"><?= $form->field($model, 'currency')->dropDownList(['uzs' => Yii::t('frontend', 'uzs'), 'usd' => Yii::t('frontend', 'usd')]); ?></div>

                            <div class="col-md-6 col-lg-4" style="margin-top: 28px;">
                    ...
                    <div class="col-lg-12" style="display: none;" id="wholesale_block">
                        <div class="row">
                            <div class="col-lg-12" id="wholesale_parent_block">
    ...
    <div class="separator"></div>
    <div class="form-group">
        <a href="<?= Url::to(['announcement/index']) ?>" class="btn btn-secondary btn-cancel"><?=Yii::t('frontend', 'Back')?></a>
        <?= Html::submitButton($model->isNewRecord ? Yii::t('frontend', 'Add announce') : Yii::t('frontend', 'Save'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
    </div>
