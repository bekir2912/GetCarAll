...
<?php if (!empty($brands)
    ...
    <section class="filter-block ">
        ...
        <button id="options-btn" class="d-md-none d-lg-none d-xl-none " style="
    width: 100%;
    text-align: center;
    padding: 6px 5px;
    background: #d91b30;
...
">
        ...
        <form class="filter-form" action="<?= Url::to(['category/index', 'id' => $category->url]) ?>" id="filter_form" data-pjax="true">
            <ul class="filter__list hidden-xs " id="options-hidden">
                <li class="filter__item">
                    ...
                    <div class="filter-button-row">
                        <div class="filter-more-reset">
                            ...
                            <?php } ?>
                            <a class="filter-reset" href="<?= Url::to(['category/index', 'id' => $category->url, 's' => Yii::$app->request->get('s'), 'sd' => Yii::$app->request->get('sd')]) ?>">
            ...
            if ($loop <= 12) {
                ?>
                    ...
                    <?php
                            ...
                            <li class="filter-result__item brands_lineups_item" style="display: none">
                                <a href="<?=Url::current(['brands' => [$brand_id]])?>">
                                    <span class="filter-result__name">
                                        <?= $brand->name ?>
                                    </span>
                ...
                <?php } else if(!empty($lineups) && empty(array_filter($checked_lineups))) {
                    ...
                    <li class="filter-result__item">
                        ...
                        <?php
                            ...
                            <li class="filter-result__item" style="display: none">
                                <a href="<?=Url::current(['lineups' => [$lineup_id]])?>">
                                    <span class="filter-result__name">
                                        <?= $lineup->translate->name ?>
                                    </span>
