...
<div class="forum-themes-list">
    <div class="forum-themes-item">
        <div class="row">
            <div class="col-lg-1">#<?=$question->id?></div>
            <div class="col-lg-7">
                ...
                <?php if($question->file) { ?>
                    <p>
                        <img src="<?= $question->file ?>" alt="" class="img-fluid">
                    </p>
                <?php } ?>
                <div class="clearfix"></div>
            </div>
            <div class="col-lg-3"><img src="<?=$ava?>" class="forum__user-image"> <?=$question->user->name?></div>
            <div class="col-lg-1"><i class="fa fa-comment-o"></i> <?=count($question->answers)?></div>
        </div>
        <div class="row">
            <div class="col-lg-12">
    ...
    <?php for($i = 0; $i < count($answers); $i++) {
        ...
        ?>
            <div class="forum-answer-item">
                ...
                <?php if($answers[$i]->file) { ?>
                    <p>
                        <img src="<?= $answers[$i]->file ?>" alt="" class="img-fluid">
                    </p>
                <?php } ?>
            </div>
    <?php } ?>
