...
<header class="header">
    ...
    <div class="submenu">
        <div class="container">
            <div class="pull-left  d-lg-none d-xl-none">
                <a href="#" target="_blank">
                    <img src="/uploads/site/appstore.jpg" alt="App Store" style="width: 75px;margin-top: 10px;">
                </a>
                <a href="#" target="_blank">
                    <img src="/uploads/site/googleplay.jpg" alt="Google Play" style="width: 75px;margin-top: 10px;">
                </a>
            </div>
