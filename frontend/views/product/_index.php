...
<?php } ?>
            <section class="car-description">
                <h2 class="car-description__heading  d-md-none hidden-xs">
                    <?= $product->translate->name ?>
                </h2>
                <p class="car-description__price  d-md-none hidden-xs">
                ...
                <div class="car-description__info d-md-none hidden-xs">
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-7">
                        ...
                        <div class="d-lg-none d-xl-none product-list__heading">
                            <?= $product->translate->name ?>
                        </div>
                        <div class="d-lg-none d-xl-none product-list__price">
                            <?php if ($product->price_type == 0) {
                                $wholesales = json_decode($product->wholesale);
                                ?>
                                <?php if ($product->price == 0) { ?>
                        ...
                        <div class="car-description__info d-lg-none d-xl-none">
                            <span class="info__item">
                                <?= date('d.m.Y', $product->created_at) ?>
                            </span>
                            <span class="info__item">
                    ...
                    <div class="col-lg-5 col-md-5 padding-none">
                        ...
                        <?php if(Yii::$app->user->isGuest || !$product->user_id || $product->user_id != Yii::$app->getUser()->identity->id) { ?>
                            <div class="hidden-xs d-md-none">
                                <div class="button-list">
                                    ...
                                    <a href="<?=Url::to(['user/messages', 'im' => $im])?>" class="button-list__item" >
                                        ...
                                        <span class="hidden-xs d-md-none"><?=Yii::t('frontend', 'Write message')?></span>
                                    </a>
                                </div>
                                <div class="button-list">
                                    <?php if (($product->shop_id && $product->shop->info->phone != '') || ($product->user_id && $product->user->phone != '')) { ?>
                                        <button class="button-list__item button-list__item_show_phone show_phone" data-prod="<?=$product->id?>">
                                            ...
                                            <span class="hidden-xs d-md-none"> <?=Yii::t('frontend', 'Show number')?></span>
                                        </button>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="d-lg-none d-xl-none">
                                ...
                                <div class="modal fade" id="phone_numbers" tabindex="-1" role="dialog" aria-labelledby="phone_numbers">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-body">
                                ...
                                <div class="button-list button-list-absolute">
                                    ...
                                    <?php if (($product->shop_id && $product->shop->info->phone != '') || ($product->user_id && $product->user->phone != '')) { ?>
                                        <button class="button-list__item button-list__item_show_phone show_phone_mobile" data-prod="<?=$product->id?>">
                                            <i class="flaticon-auricular-phone-symbol-in-a-circle" style="color: #27ae60!important;margin-right: 7px;"></i>
                                            <span class=""> <?=Yii::t('frontend', 'Show number')?></span>
                                        </button>
                                    <?php } ?>
                                </div>
                            </div>
                ...
                <div class="car-description__tabs">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#comment" data-toggle="tab">
                                <span class="d-xl-none d-lg-none"><i class="fa fa-comment-o text-success fa-2x"></i></span>
                                <span class="hidden-xs d-md-none"><?=Yii::t('frontend', 'Seller description')?></span>
                            </a></li>
                        <?php if($category_spec == 1) { ?>
                            <li><a href="#equipment" data-toggle="tab">
                                    <span class="d-xl-none d-lg-none"><i class="fa fa-truck text-danger fa-2x"></i></span>
                                    <span class="hidden-xs d-md-none"><?=Yii::t('frontend', 'Delivery')?></span>
                                </a></li>
                            <li><a href="#reference" data-toggle="tab">
                                    <span class="d-xl-none d-lg-none"><i class="fa fa-shield text-warning fa-2x"></i></span>
                                    <span class="hidden-xs d-md-none"><?=Yii::t('frontend', 'Warranty')?></span>
                                </a></li>
                        <?php } else { ?>
                            <li><a href="#equipment" data-toggle="tab">
                                    <span class="d-xl-none d-lg-none"><i class="fa fa-cogs text-danger fa-2x"></i></span>
                                    <span class="hidden-xs d-md-none"><?=Yii::t('frontend', 'Product Options')?></span>
                                </a></li>
                            <li><a href="#reference" data-toggle="tab">
                                    <span class="d-xl-none d-lg-none"><i class="fa fa-info-circle text-info fa-2x"></i></span>
                                    <span class="hidden-xs d-md-none"><?=Yii::t('frontend', 'Lineup Info')?></span>
                                </a></li>
                        <?php } ?>
                    </ul>
                    <!-- Tab panes -->
