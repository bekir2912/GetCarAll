                                ...
                                <div class="row">
                                    <div class="col-md-2 col-lg-1">
                                        <a href="<?= Url::to(['shop/index', 'id' => $order->shop->url]) ?>">
                                            <img src="<?=$order->shop->logo?>" alt="<?=$order->shop->name?>" class="img-fluid center-block">
                                        </a>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-lg-1">
                                            <a href="<?= Url::to(['product/index', 'id' => $product->product->url]) ?>">
                                                <img src="<?=$product->product->mainImage->image?>" alt="<?=$product->product->translate->name?>" class="img-fluid center-block">
                                            </a>
                                        </div>
                                        <div class="col-md-8 col-lg-9">
