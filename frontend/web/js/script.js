$(function() {
    ...
    $('.show_phone').on('click', function () {
        ...
        $.ajax({
            ...
            type: "post",
            success: function (t) {
                link.html('<img src="/gta/images/phone.svg" alt=""> ' + t);
                link.removeClass('show_phone');
            }
        });
    });
    $('.show_phone_mobile').on('click', function () {
        link = $(this);
        if(link.hasClass('loaded')) {
            $('#phone_numbers').modal('show');
        } else {
            $.ajax({
                url: "/site/show-number",
                data: {'id': link.attr('data-prod')}, //data: {}
                ...
                success: function (t) {
                    ...
                    $.each(t, function (index, value) {
                       temp += '<a href="tel:' + value + '">' + value + '</a><br />'
                    });
                    temp += '</p>';
                    $('#phone_numbers').find('.modal-body').html(temp);
                    $('#phone_numbers').modal('show');
...
$('#news_slider').on('initialized.owl.carousel', function () {
