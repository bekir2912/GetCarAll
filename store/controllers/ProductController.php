...
//                }
                ...
                if($image){
                    ...
                    $image_model->product_id = $model->id;
                    $image_model->main = 1;
                    $image_model->image = '/uploads/site/getcar.png';
                    $image_model->save();
                }
...
//                    ProductOption::deleteAll(['product_id' => $model->id]);
    ...
    public function actionBoost($id) {
        ...
        $user = Seller::findOne(Yii::$app->user->id);
...
//     */
    ...
    {
        if (($model = Product::findOne(['shop_id' => Yii::$app->session->get('shop_id'), 'id' => $id, 'deleted_at' => 0])) !== null) {
            return $model;
        } else {
