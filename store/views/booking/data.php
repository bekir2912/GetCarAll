...
//	require_once('lib/dhtmlxScheduler/connector/scheduler_connector.php');
	require_once('../../web/booking_calendar/lib/dhtmlxScheduler/connector/scheduler_connector.php');
//	include ('config.php');


	require_once('../../web/booking_calendar/lib/dhtmlxScheduler/connector/db_pdo.php');
	...
	$scheduler->set_options("booking-status", $bookingstatuses);
