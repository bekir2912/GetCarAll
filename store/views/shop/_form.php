...
<!--                <img src="--><?//= $model->logo ?><!--" alt="--><?//= $model->logo ?><!--" class="img-responsive">-->
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#ru" aria-controls="ru" role="tab" data-toggle="tab"><?=Yii::t('frontend', 'ru')?></a>
                </li>
                <li role="presentation"><a href="#uz" aria-controls="uz" role="tab" data-toggle="tab"><?=Yii::t('frontend', 'uz')?></a></li>
                <li role="presentation"><a href="#oz" aria-controls="oz" role="tab" data-toggle="tab"><?=Yii::t('frontend', 'oz')?></a></li>
    ...
    <p><br></p>
    <div class="separator"></div>
    <h4>В каком городе вы предоставляете услуги?</h4>
    <div class="row">
            <?php
    ...
    <div class="form-group text-center">
        <?php if (!empty(Shop::findOne(Yii::$app->session->get('shop_id')))) { ?>
            <a href="<?= Url::to(['shop/index']) ?>" class="btn btn-secondary btn-cancel">Мои прокатные организации</a>
        <?php } ?>
