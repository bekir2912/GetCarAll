(function () {
	...
	scheduler.templates.event_bar_text = function (start, end, event) {
		...
		return [event.text + "<br />",
			startDate + " - " + endDate,
			"<div class='booking-status booking-option'>" + getBookingStatus(event.status) + "</div>",
	...
	scheduler.attachEvent("onXLE", function () {
		...
		var selectHTML = ["<option value='all'>Все</option>"];
...
function init() {
	...
	(function () {
		...
		var descriptionHTML = "<div class='timeline_item_separator'></div>" +
			...
			"<div class='timeline_item_separator'></div>" +
			"<div class='timeline_item_cell'>Тип</div>" +
			"<div class='timeline_item_separator'></div>" +
			"<div class='timeline_item_cell room_status'>Статус</div>";
